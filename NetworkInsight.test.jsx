...
jest.mock('../../ResponsiveLayout', () => ({
  Box: ({ children, ...props }) => <div data-testid="responsive-box" {...props}>{children}</div>,
  HStack: ({ children, ...props }) => <div data-testid="responsive-hstack" {...props}>{children}</div>,
  Stack: ({ children, ...props }) => <div data-testid="responsive-stack" {...props}>{children}</div>
}));
